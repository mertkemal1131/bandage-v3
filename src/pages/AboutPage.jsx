...
export default function AboutPage() {
  ...
  return (
    <div className="font-['Montserrat'] bg-white">
      ...
      {/* Hero split */}
      <div className="grid grid-cols-2 max-w-[1050px] mx-auto px-6 py-20 gap-[60px] items-center">
      ...
      <div className="bg-[#FAFAFA] py-[60px]">
        <div className="max-w-[1050px] mx-auto px-6">
          ...
          <div className="grid grid-cols-4 gap-6">
            {stats.map(({ n, l }) => (
              <div key={l} className="bg-white rounded-[5px] py-10 px-6 text-center border border-[#E8E8E8]">
      ...
      <div className="bg-[#FAFAFA] py-20">
        <div className="max-w-[1050px] mx-auto px-6">
          ...
          <div className="grid grid-cols-3 gap-6">
            {[
              { Icon: Target,    bg: '#EBF8FF', c: '#23A6F0', title: 'Easy Wins',   desc: 'Get your best looking smile now!' },
              { Icon: BarChart2, bg: '#EAFAF3', c: '#2DC071', title: 'Concrete',    desc: 'Assurance that blocks are in the right place.' },
              { Icon: TrendingUp,bg: '#FFF4EE', c: '#E77C40', title: 'Hack Growth', desc: 'Problems trying to resolve the conflict.' },
            ].map(({ Icon, bg, c, title, desc }) => (
              <div key={title} className="bg-white py-10 px-6 text-center rounded-[5px] border border-[#E8E8E8]">
                <div className="w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4" style={{ background: bg }}>
